...
<section class="relative text-sm flex flex-col max-w-4xl mx-auto mt-12">
  ...
  >
    <li
      class="relative bg-white dark:bg-gray-700 cursor-pointer w-full p-3 font-mono rounded-xl hover:ring-2 ring-1 transition duration-150 ring-gray-200 shadow-lg hover:shadow-xl flex flex-col justify-between"
